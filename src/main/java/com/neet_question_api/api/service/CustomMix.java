...
//        ObjectMapper objectMapper = new ObjectMapper();
        ...
        System.out.println(ch_ids);
        for (ChapterIds chapter : ch_ids) {
            System.out.println(chapter.getChapter_id().toLowerCase()+ " this is the chapter id from custom mox");
            List<Questions> questions = fetchQuestions(chapter.getChapter_id().toLowerCase(), chapter.getQuestion_number());
